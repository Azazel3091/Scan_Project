...
import {GeneralResultLoader, Slider} from '../Slider'
...
async function fetchDetailData(documentIds) {
  try {
    ...
    console.error("Не удалось получить подробные данные.", error);
    return null;
  }
}
  ...
  return (
    <main className={styles.result}>
      ...
      <div className={styles.summaryBlock}>
        ...
        {<Slider isLoading={!resultGeneralData} data={!resultGeneralData
          ? []
